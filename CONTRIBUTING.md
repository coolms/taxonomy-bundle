# Contributing to `coolms/taxonomy-bundle`
...
`coolms/taxonomy-bundle` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/taxonomy-bundle 2.0.0` does not assert that this package broke something; it
